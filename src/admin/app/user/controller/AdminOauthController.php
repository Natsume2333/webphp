...
class AdminOauthController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $lists = $oauthUserQuery->field('a.*,u.user_nickname,u.sex,u.avatar')->alias('a')->join('__USER__ u','a.user_id = u.id')->where("a.status", 1)->order("create_time DESC")->paginate(10);
        // 获取分页显示
        $page = $lists->render();
