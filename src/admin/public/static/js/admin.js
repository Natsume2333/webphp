...
//推送消息
    $(".is_audit_status").click(function(){
        var url=$(this).attr("data-url");
        //询问框
        layer.confirm('推送消息是否自定义模板？', {
            btn: ['自定义','模板'] //按钮
        }, function(){
            layer.prompt({title: '推送消息，并确认', formType: 2}, function(text, index){
                layer.close(index);
            ...
            window.location.href=url+="?center=0";
        });
...
function openUploadDialog(dialog_title, callback, extra_params, multi, filetype, app) {
    ...
    Wind.use("artDialog", "iframeTools", function () {
        art.dialog.open(GV.ROOT + 'index.php/user/Asset/webuploader?' + params, {
            title: dialog_title,
            id: new Date().getTime(),
            width: '600px',
            height: '350px',
